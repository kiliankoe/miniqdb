...
type ClientQuote = Pick<Quote, "id" | "body" | "file" | "createdAt"> & { score: number };
...
function VoteView({ score, disabled }: { score: number; disabled: boolean }) {
  const sharedClasses =
    "rounded-sm px-1 py-0 active:translate-y-0.5 disabled:cursor-not-allowed disabled:bg-gray-400 dark:disabled:bg-gray-700";
  return (
